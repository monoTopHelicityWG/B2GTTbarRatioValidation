...
//if V10 https://twiki.cern.ch/twiki/bin/viewauth/CMS/SWGuideMuonIdRun2
 ...
 //c1.SaveAs("test.png"); 
    ...
    TH1F* TH1F_gen_Ratio_afterMHT = new TH1F("TH1F_gen_Ratio_afterMHT", "Gen Ratio after MHT trigger: E(b)/E(t);  E(b)/E(t); count", nBins, 0, 1.5 );
    TH1F* TH1F_had_Ratio_afterMHT = new TH1F("TH1F_had_Ratio_afterMHT", "Ratio: E(b)/E(t)after MHT trigger;  E(b)/E(t); count", nBins, 0, 1.5 );
   ...
   // TH1F* TH1F_three_gen_pT = new TH1F("TH1F_three_gen_pT", "Three Jet(s) Gen pT: E(b)/E(t);  E(b)/E(t); count", nBins, 0, 2000 );
    ...
    //trigsToRun.push_back("HLT_PFMET120_PFMHT120_IDTight_v");
 ...
 //trigsRun.push_back("HLT_PFMET120_PFMHT120_IDTight_v");
...
//           
            ...
            TH1F_gen_Ratio_afterMHT->Fill(gen_ratio);
            TH1F_had_Ratio_afterMHT->Fill(matchedRatio);
