...
// Sun Oct  8 11:47:29 2017 by ROOT version 6.08/07
// from TTree TreeHad/TreeHad
// found on file: b2gtreeV5_MC_MonoTop_2.root
//////////////////////////////////////////////////////////

#ifndef HadTree_Oct_8_17_h
#define HadTree_Oct_8_17_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HadTree_Oct_8_17(TTree *tree=0);
   virtual ~HadTree_Oct_8_17();
...
#ifdef HadTree_Oct_8_17_cxx
HadTree_Oct_8_17::HadTree_Oct_8_17(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("b2gtreeV5_MC_MonoTop_2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("b2gtreeV5_MC_MonoTop_2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("b2gtreeV5_MC_MonoTop_2.root:/ana");
...
HadTree_Oct_8_17::~HadTree_Oct_8_17()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HadTree_Oct_8_17::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HadTree_Oct_8_17::LoadTree(Long64_t entry)
{
...
void HadTree_Oct_8_17::Init(TTree *tree)
{
...
Bool_t HadTree_Oct_8_17::Notify()
{
...
void HadTree_Oct_8_17::Show(Long64_t entry)
{
...
Int_t HadTree_Oct_8_17::Cut(Long64_t entry)
{
...
#endif // #ifdef HadTree_Oct_8_17_cxx
